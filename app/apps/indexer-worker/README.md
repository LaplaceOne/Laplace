...
npx wrangler d1 migrations apply laplace-indexer --remote

# 3. (Recommended) set a dedicated RPC as a secret (else the public devnet RPC is used).
npx wrangler secret put LAPLACE_RPC_URL     # e.g. https://devnet.helius-rpc.com/?api-key=…
